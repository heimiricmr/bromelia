...
INSERT_SUBSCRIBER_DATA_MESSAGE = convert_to_3_bytes(319)
PURGE_UE_MESSAGE = convert_to_3_bytes(321)
RESET_MESSAGE = convert_to_3_bytes(322)
...
DSR_FLAGS_AVP_CODE = convert_to_4_bytes(1421)
...
USER_ID_AVP_CODE = convert_to_4_bytes(1444)
...
SS_CODE_AVP_CODE = convert_to_4_bytes(1476)
TS_CODE_AVP_CODE = convert_to_4_bytes(1487)
IDR_FLAGS_AVP_CODE = convert_to_4_bytes(1490)
...
SUBSCRIPTION_DATA_DELETION_AVP_CODE = convert_to_4_bytes(1685)
